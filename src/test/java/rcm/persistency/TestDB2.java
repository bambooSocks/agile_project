...
public class TestDB2 {
    ...
    public void testData() throws WrongInputException, IOException {
        ...
        lc1 = app.createNewLogisticsCompany("3P Logistics A/S", "Rendebanen 6D, 6000 Kolding", "Peter Hansen",
        ...
        cl2 = app.createNewClient("Novo Enzymes", "Smorumvej 43", "Linea Hansen", "linea@novoenzymes.dk",
                "Password12345");
        c1 = app.createNewContainer();
        app.logInUser("tom@cbs.dk", "Tom123456");
        j1 = app.requestNewJourney("Copenhagen", "New York", "robots", null); // if you pass null then the journey
                                                                              // doesn't start straight away ...
                                                                              // otherwise give it a timestamp
    }
