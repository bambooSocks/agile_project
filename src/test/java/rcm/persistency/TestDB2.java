...
public class TestDB2 {
    ...
    public static void setupFakeApp(Application app) throws WrongInputException, IOException {
        ...
        app.createNewClient("Novozymes", "Smorumvej 43", "William Andersen", "william@novozymes.dk", "Password12345");
        for (int i = 0; i < 8; i++) {
        ...
        app.enterNewContainerStatus(j1.getId(),
