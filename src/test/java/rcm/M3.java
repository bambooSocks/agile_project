...
////		company = new LogisticsCompany(companyName);
//	}
//
...
//	}
	...
	public void a_first_logistic_company_with_address_reference_person_and_email(String string, String string2, String string3, String string4) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("a first client {string} with address {string}, reference person {string} and email {string}")
	public void a_first_client_with_address_reference_person_and_email(String string, String string2, String string3, String string4) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("a container of first logistic company with ID {int}")
	public void a_container_of_first_logistic_company_with_ID(Integer int1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void a_journey_of_given_container_and_first_client_with_origin_port_of_destination_port_of_and_a_content_of(String string, String string2, String string3) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("a container status of {int} degrees, {int} % humidity and {double} bar to the given journey")
	public void a_container_status_of_degrees_humidity_and_bar_to_the_given_journey(Integer int1, Integer int2, Double double1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void a_second_logistic_company_with_address_reference_person_and_email(String string, String string2, String string3, String string4) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void a_journey_of_no_container_and_first_client_with_origin_port_of_destination_port_of_and_a_content_of(String string, String string2, String string3) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Given("an initial container status in the journey of {int} degrees, {int} % humidity and {double} bar")
	public void an_initial_container_status_in_the_journey_of_degrees_humidity_and_bar(Integer int1, Integer int2, Double double1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void a_second_client_with_address_reference_person_and_email(String string, String string2, String string3, String string4) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
