...
////	code snippets for M1:1
    ...
    public void a_logistic_company_with_address_reference_person_and_email(String name, String address,
...
//		searchResults = client.searchProfiles(searchParam);
    ...
    public void a_logistic_company_enters_client_data_of_and_to_the_client_profile(String name, String address,
            String refPerson, String email) {
...
//	code snippets for M1:3
    ...
    public void a_client_with_address_reference_person_email_and_ID(String name, String address, String refPerson,
...
//		this will give errors unless we add id to the profile in the Client class
    ...
    public void the_client_profile_is_changed_to_address_reference_person_email_and_ID(String name, String address,
            String refPerson, Integer id) {
