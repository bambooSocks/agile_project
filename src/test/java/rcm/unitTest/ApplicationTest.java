...
public class ApplicationTest {
    ...
    public void init() throws WrongInputException, IOException {
        ...
        app.createNewLogisticsCompany("Maersk", "Kbh", "Someone", "info6@maersk.com", "Agile123");
        app.logInUser("info6@maersk.com", "Agile123");
        container = app.createNewContainer();
        client = app.createNewClient("Novo Nordisk", "Kbh", "Someone else", "info6@novonordisk.com", "Object123");
        client2 = app.createNewClient("Dole", "Florida", "Someone completely different", "dole@bananas.com",
                "Object123");
        app.logInUser("info6@novonordisk.com", "Object123");
    ...
    public void testSearchForClients() throws WrongInputException, IOException {
        ...
        assertTrue(app.searchForClients("info6@novonordisk.com").contains(client1));
