...
public class LogisticsCompany extends User {
    ...
    /**
     * Method to search clients by hashKey
     * 
     * @param hashKey Search criteria
     * @return Set of clients that have a matching hashKey
     */
    ...
    /**
     * Method to view the data of a logistics company
     * 
     * @param loggedIn boolean representing the log-in status of the logistics
     *                 company
     * @param email1   Email of the firstS logistics company
     * @param email2   Email of the second logistics company
     * @return Set of all clients of the logistics company or null if requirements
     *         are not met
     */
