...
Feature: Client searching
  ...
  Scenario: Successful search using email
    ...
    Then it exists and the client "Novo Nordisk" with address "Novo Alle, 2880 Bagsvaerd" reference person "Lars Fruergaard Joergensen" and email "info@novonordisk.com" is returned
  ...
  Scenario: Successful search using name
    ...
    Then it exists and the client "Chiquita" with address "1855 Griffin Rd. Miami, Florida" reference person "Carmen Rodriguez" and email "bananas@chiquita.com" is returned
