...
Feature: Profile information update
  ...
  Scenario: Unsuccessful client profile update
    Given a first logistics company "Maersk" with address "Esplanaden 50, 1098 Koebenhavn K" reference person "Soeren Skou" email "info@maersk.com" and password "Agile123"
    And a first client "Chiquita" with address "1855 Griffin Rd. Miami, Florida" reference person "Carmen Rodriguez" email "bananas@chiquita.com" and password "Object123"
    When a client enters new client info "aChiquita7" with address "3?" reference person "car7men Rodriguez Jr." email "bigyellowbananas.com" and password "lamepassword"
    Then the client "aChiquita7" with address "3?" reference person "car7men Rodriguez Jr." email "bigyellowbananas.com" and password "lamepassword" is not updated
  ...
  Scenario: Unsuccessful logistics company profile update
    Given a first logistics company "Maersk" with address "Esplanaden 50, 1098 Koebenhavn K" reference person "Soeren Skou" email "info@maersk.com" and password "Agile123"
    When a logistics company enters new info "hamburgSud?" with address "3?" reference person "car7men Rodriguez Jr." email "bigyellowbananas.com" and password "lamepassword"
    Then the logistics company "hamburgSud?" with address "3?" reference person "car7men Rodriguez Jr." email "bigyellowbananas.com" and password "lamepassword" is not updated
